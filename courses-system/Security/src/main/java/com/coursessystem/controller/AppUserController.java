...
public class AppUserController {
    ...
    public ResponseEntity<AppUser> get(@RequestHeader("Authorization") String authorization, @PathVariable Long id) {
    	try {
    ...
    public ResponseEntity<List<AppUser>> getAll(@RequestHeader("Authorization") String authorization) {
    ...
    public ResponseEntity<ResponseGeneral> register(@RequestHeader("Authorization") String authorization, @RequestBody @Valid PostAppUser user, BindingResult result) {
		if (result.hasErrors())
    ...
    public ResponseEntity<ResponseGeneral> update(@RequestHeader("Authorization") String authorization, @RequestBody @Valid AppUser user, BindingResult result) {
		if (result.hasErrors())
            return new ResponseEntity<>(new ResponseGeneral(HttpStatus.BAD_REQUEST, result.getFieldError().getField() + " " + result.getFieldError().getDefaultMessage()), HttpStatus.BAD_REQUEST);
		try {
